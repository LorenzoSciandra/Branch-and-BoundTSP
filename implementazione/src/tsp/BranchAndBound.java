...
public class BranchAndBound {
    ...
    private void branching(SubProblem problemaCorrente) {
        List<Edge<Integer,Integer>> sottoCiclo = dfs(problemaCorrente.getUnoTree().getNode(nodoCandidato),new ArrayList<>());
    ...
    private List<Edge<Integer,Integer>> dfs(Node<Integer, Integer, Integer> nodoCorrente, ArrayList<Edge<Integer, Integer>> cicloInterno){
